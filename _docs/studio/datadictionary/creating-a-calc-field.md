...
To create a calculated field for a particular table, click the Add button (![](images\addbutton.png)) beside the Calculated Fields node in the TreeView for that table. 
